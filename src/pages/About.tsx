        ...
        <div className="container grid gap-12 lg:grid-cols-[1fr_1.05fr] lg:items-center">
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-base leading-relaxed text-muted-foreground">
              ...
              <p className="text-lg font-semibold text-foreground">"World-class treatment, right here at home. Because every patient deserves care without the burden of travel."</p>
              <p>
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container grid gap-10 lg:grid-cols-[1fr_0.9fr]">
          ...
          <div className="rounded-3xl bg-gradient-hero p-8 text-primary-foreground shadow-soft">
            ...
            <p className="mt-4 text-sm leading-relaxed text-primary-foreground/85">Dr. Shreyans Patel is known for his patient-first approach — clear communication, ethical counselling and steady support through every stage of treatment.</p>
